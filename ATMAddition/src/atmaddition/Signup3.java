...
public class Signup3 extends JFrame implements ActionListener{
    ...
    Signup3(String formno){
        ...
        JLabel number = new JLabel("XXXX-XXXX-XXXX-5462");
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==submit){
            ...
            long first14Digits = Math.abs(random.nextLong() % 900000000000000L) + 5040936000000000L;
            String cardnumber = String.valueOf(first14Digits);
            String pinnumber = String.format("%04d", random.nextInt(9000) + 1000);
            
            String facility = "";
            if(c1.isSelected())facility = facility + "ATM Card";
            else if(c2.isSelected())facility = facility + "Interned Banking";
